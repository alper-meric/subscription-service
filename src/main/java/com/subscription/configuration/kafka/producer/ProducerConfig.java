...
public class ProducerConfig {
    ...
    @Bean
    public ProducerFactory<String, SubscriptionStatusUpdated> subscriptionEventProducerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, SubscriptionStatusUpdated> subscriptionEventKafkaTemplate() {
    ...
    @Bean
    public KafkaTemplate<String, PaymentStatusUpdated> paymentStatusUpdatedKafkaTemplate() {
